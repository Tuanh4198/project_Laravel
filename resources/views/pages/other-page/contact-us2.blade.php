        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="contact-form">
                    ...
                    <form id="main-contact-form" class="contact-form row" name="contact-form" method="POST" action="{{URL::to('/send-mess')}}" >
                    {{ csrf_field() }}
                    @foreach($customer as $key => $ct )
                        <div class="form-group col-md-6">
                            <input type="text" name="name" class="form-control" required="required" placeholder="Name" value="{{  $ct->customer_name }}">
                        </div>
                        <div class="form-group col-md-6">
                            <input type="email" name="email" class="form-control" required="required" placeholder="Email" value="{{  $ct->customer_email }}">
                        </div>
