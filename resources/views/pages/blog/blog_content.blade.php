    ...
    <div class="col-sm-3">
        ...
        <div class="col-sm-9 padding-right" style="padding-top: 15px;">
            <div class="blog-post-area">
                ...
                <div class="single-blog-post" style="display: flex; flex-direction: column;">
                    <a href="">
                        <img src="{{URL::to('public/upload/blog/'.$bl->blog_image)}}" alt="">
                    </a>
                    <h3 style="font-weight: bolder; text-align: center; font-size: 25px; margin-top: 15px;"> {{ $bl->blog_name }}</h3>
                    <div class="post-meta"> Date: {{ $bl->created_at }} </div>
                    <diw style="line-height: 20px; padding: 10px; overflow: unset; max-height: unset;">
                        <?php
                        echo $bl->blog_content;
                        ?>
                    </diw>
                </div>
                @endforeach
                    ...
                    data-prev-Arrow='.recommended_items .left'>
                        @foreach($brand as $key => $bra )
                            <div class="item-brand wow zoomIn" style="padding: 0px 15px;">
                                <a href="{{URL::to('/show-brands-products/'.$bra->brand_id)}}">
                                    <img src="{{URL::to('public/upload/brand/'.$bra->brand_img)}}" width="200" height="100">
                                </a>
                            </div>
                        @endforeach
                    </div>
