				...
				<div class="position-center">
					...
					<form role="form" action="{{URL::to('/update-product/'.$edit_value->product_id)}}" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" name="product_qty" class="form-control" id="exampleInputEmail1"  value="{{$edit_value->product_qty}}">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Describe</label>
							<textarea name="product_describe" class="form-control" id="editor1" rows="5" style="resize: none;">{{$edit_value->product_desc}}</textarea>
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Content</label>
							<textarea name="product_content" class="form-control" id="editor2" rows="5" style="resize: none;">{{$edit_value->product_content}}</textarea>
						</div>
						<div class="form-group">
